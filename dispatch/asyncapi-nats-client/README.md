...
<p align="center">
  <em>This is a generated TypeScript/Node.js NATS client for the application - Central Dispatch for Software Updates.</em>
</p>
...
This service handles dispatching PrintNanny OS software update requests to an individual device
