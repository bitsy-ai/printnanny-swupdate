...
import * as piPiIdEventSoftwareUpdateChannel from "./channels/PiPiIdEventSoftwareUpdate";
...
export class NatsAsyncApiClient {
   ...
   */
  public requestPiPiIdEventSoftwareUpdate(
    requestMessage: SoftwareUpdateRequest, pi_id: Number,
    options ? : Nats.RequestOptions
  ): Promise < SoftwareUpdateReply > {
    if (!this.isClosed() && this.nc !== undefined && this.codec !== undefined) {
      return piPiIdEventSoftwareUpdateChannel.request(
        requestMessage,
        this.nc,
        this.codec, pi_id,
        options
